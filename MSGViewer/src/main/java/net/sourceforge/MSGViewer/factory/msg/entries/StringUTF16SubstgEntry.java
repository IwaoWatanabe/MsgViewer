...
public class StringUTF16SubstgEntry extends SubStorageEntry {
    ...
    protected InputStream createEntryContent() {
        switch (type) {
        case PtypString8: return new ByteArrayInputStream(value.getBytes(StandardCharsets.ISO_8859_1));
        case PtypString:  return new ByteArrayInputStream(value.getBytes(StandardCharsets.UTF_16LE));
